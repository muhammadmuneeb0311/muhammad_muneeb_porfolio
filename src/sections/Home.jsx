...
const socials = [
  ...
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/muhammad-muneeb-aa630a2b4/?skipRedirect=true" },
  
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/muhammadmuneeb0311" },
];
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              Hello, I&apos;m
              <br />
              <span className="text-white font-bold text-3xl sm:text-4xl md:text-5xl lg:text-7xl lg:whitespace-nowrap">
                Muhammad Muneeb
              </span>
            </motion.h1>
            ...
            >
              ...
              <a
                href="/Muhammad_Muneeb Resume.pdf"
                download
